...
Network = [
    ...
    # Build OR Perceptron
    [ Perceptron(np.array([1./2,1./2]),1./4) ],\
    # output node, declare output layer perceptron here
    # Build AND Perceptron  
    [ Perceptron(np.array([1./2,1./2]),3./4) ]
]
...
def EvalNetwork(inputValues, Network):
    ...
    for node in Network[0]:
        outputLayer1 = node.activate(inputValues)

    outputLayer2 = 0
    for node in Network[1]:
        outputLayer2 = node.activate(inputValues)

    OutputValue = outputLayer1 - outputLayer2
